...
$router->get('/admin/gallery/create', [AdminController::class, 'createGallery']);
$router->get('/admin/gallery/{id}/edit', [AdminController::class, 'editGallery']);
$router->post('/admin/gallery/save', [AdminController::class, 'saveGallery']);
$router->post('/admin/gallery/{id}/delete', [AdminController::class, 'deleteGallery']);
